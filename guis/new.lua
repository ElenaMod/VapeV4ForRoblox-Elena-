...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://github.com/ElenaMod/VapeV4ForRoblox-Elena-/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://github.com/ElenaMod/VapeV4ForRoblox-Elena-/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
